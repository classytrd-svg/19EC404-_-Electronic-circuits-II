...
<img width="1502" height="1599" alt="image" src="https://github.com/user-attachments/assets/cee1b80b-bf4a-4530-9d0f-93a6738b9f60" />


# Graph

<img width="900" height="1600" alt="image" src="https://github.com/user-attachments/assets/5df7ccdd-9cae-4353-a276-1a2a9f3efa1a" />


# Sample images 

![WhatsApp Image 2025-11-20 at 9 59 59 PM](https://github.com/user-attachments/assets/b5022ff1-5eb8-4d2c-b8e5-269170de0ddc)
...
|:----:|-------------|:----------------:|:--------------:|
| 1 | Lower cut-off frequency | f1=5hz | f1=3.5khz |
| 2 | Upper cut-off frequency | f2=1.5mhz | f2=550khz |
| 3 | Bandwidth | \( BW = fh - fl =1.495mhz \) | \( BW = f'h - f'l = 546.5khz\) |
| 4 | Mid-band Gain | \( A{v(mid)} = 26.52\) | \( A'{v(mid)} = 11.12\) |
| 5 | Gain at half power point | 18.75 | 7.86 |
